...
function HeadSprite:initHeadSprite( useritem )
    ...
    --print("HeadSprite:initHeadSprite, isThirdParty:" .. tostring(isThirdParty) .. ", szThirdPartyUrl:" .. tostring(useritem.szThirdPartyUrl))
		...
		if bHave then
			...
			self:downloadFace(url, path, filename, function(downloadfile)
				...
				if selffile == downloadfile then
            		...
            		--处理图片大小
            		reSizeGivenFile(filepath, filepath, "g_FaceResizeListener", self.m_headSize)
