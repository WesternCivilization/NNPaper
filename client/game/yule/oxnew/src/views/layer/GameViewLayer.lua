...
local pointPlayer = {cc.p(877, 610), cc.p(88, 410), cc.p(157, 115), cc.p(1200, 410)}
local pointCard = {cc.p(640, 584), cc.p(298, 402), cc.p(667, 110), cc.p(988, 402)}
local pointClock = {cc.p(1017, 615), cc.p(88, 556), cc.p(157, 255), cc.p(1200, 556)}
local pointOpenCard = {cc.p(437, 610), cc.p(288, 285), cc.p(1117, 115), cc.p(990, 285)}
local pointCardType = {cc.p(437, 610), cc.p(288, 285), cc.p(910, 115), cc.p(990, 285)}
local pointTableScore = {cc.p(640, 490), cc.p(491, 410), cc.p(640, 330), cc.p(810, 410)}
local pointBankerFlag = {cc.p(948, 714), cc.p(159, 499), cc.p(228, 204), cc.p(1120, 495)}
local pointChat = {cc.p(767, 665), cc.p(160, 525), cc.p(230, 250), cc.p(1130, 525)}
local pointUserInfo = {cc.p(445, 240), cc.p(182, 305), cc.p(205, 170), cc.p(720, 305)}
...
function GameViewLayer:ctor(scene)
	...
	self.btSwitch = self._csbNode:getChildByName("bt_switch")
		...
		:setPosition(yl.WIDTH-58,yl.HEIGHT-60)
	...
	for i = 1 ,cmd.GAME_PLAYER do
		...
		local spriteFrame = display.newSprite(GameViewLayer.RES_PATH.."bg_head.png")
		...
		cc.Label:createWithTTF("小白狼大白兔", "fonts/round_body.ttf", 18)
			...
			:addTo(self.nodePlayer[i])
		--金币
		-- cc.LabelAtlas:_create("123456", GameViewLayer.RES_PATH.."num_chipScore.png", 20, 28, string.byte("0"))
		cc.Label:createWithTTF("123456", "fonts/round_body.ttf", 18)
			:move(12, -63)
			:setAnchorPoint(cc.p(0.5, 0.5))
...
function GameViewLayer:OnUpdateUser(viewId, userItem)
	...
	if not userItem then
		...
		if not head then
			...
			display.newSprite(GameViewLayer.RES_PATH.."frame_head.png")
				--:move(1, 1)
				:addTo(head)
